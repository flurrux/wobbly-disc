...
},{}],"../node_modules/fp-ts/lib/Apply.js":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Apply":"../node_modules/fp-ts/lib/Apply.js","./Chain":"../node_modules/fp-ts/lib/Chain.js","./function":"../node_modules/fp-ts/lib/function.js","./Functor":"../node_modules/fp-ts/lib/Functor.js","./NonEmptyArray":"../node_modules/fp-ts/lib/NonEmptyArray.js","./Option":"../node_modules/fp-ts/lib/Option.js","./ReadonlyArray":"../node_modules/fp-ts/lib/ReadonlyArray.js","./Separated":"../node_modules/fp-ts/lib/Separated.js"}],"../lib/vec3.ts":[function(require,module,exports) {
"use strict";
...
},{"../src/util":"../src/util.ts"}],"../src/scalar-value-order.ts":[function(require,module,exports) {
"use strict";
...
function calculateScalarFieldOrder(camPosition, field) {
  ...
  return __spreadArrays(function_1.pipe(rect, findQuadrantRects, Array_1.map(getSortedPixelsFromQuadrantRect), Array_1.flatten), function_1.pipe(rect, findMainLines, Array_1.map(getSortedPixelsFromGridLine), Array_1.flatten));
}

exports.calculateScalarFieldOrder = calculateScalarFieldOrder;
},{"../lib/vec2":"../lib/vec2.ts","fp-ts/lib/function":"../node_modules/fp-ts/lib/function.js","fp-ts/lib/Array":"../node_modules/fp-ts/lib/Array.js","fp-ts/lib/number":"../node_modules/fp-ts/lib/number.js","fp-ts/lib/Option":"../node_modules/fp-ts/lib/Option.js"}],"scalar-field-order-demo.ts":[function(require,module,exports) {
"use strict";
...
var scalar_value_order_1 = require("../src/scalar-value-order");
...
function drawRect() {
  var _a = Array_1.sort(number_1.Ord)([rectCorners[0][0], rectCorners[1][0]]),
      minX = _a[0],
      maxX = _a[1];

  var _b = Array_1.sort(number_1.Ord)([rectCorners[0][1], rectCorners[1][1]]),
      minY = _b[0],
      maxY = _b[1];
...
function animate(duration, animate) {
  return new Promise(function (resolve) {
    var startTime = window.performance.now();

    var loop = function loop() {
      var curTime = window.performance.now();
      var elapsedTime = Math.min(duration, curTime - startTime);
...
function canvasToScenePoint(e) {
  return Vec2.round([(e.offsetX - canvas.width / 2) / canvasScale, (e.offsetY - canvas.height / 2) / -canvasScale]);
}

canvas.addEventListener("pointerdown", function (e) {
  var point = canvasToScenePoint(e);
...
function revealVoxels(voxels) {
  return __awaiter(this, void 0, void 0, function () {
    var _i, voxels_1, voxel;

    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _i = 0, voxels_1 = voxels;
          _a.label = 1;

        case 1:
          if (!(_i < voxels_1.length)) return [3
          /*break*/
          , 4];
          voxel = voxels_1[_i];
          drawVoxel(voxel);
...
document.addEventListener("keydown", function (e) {
  ...
  var voxelPoints = scalar_value_order_1.calculateScalarFieldOrder([0, 0, 0], {
    cellSize: 1,
    position: [minX, minY],
...
},{"fp-ts/lib/Array":"../node_modules/fp-ts/lib/Array.js","fp-ts/lib/number":"../node_modules/fp-ts/lib/number.js","../lib/vec2":"../lib/vec2.ts","../src/scalar-value-order":"../src/scalar-value-order.ts"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scalar-field-order-demo.ts"], null)
//# sourceMappingURL=/scalar-field-order-demo.8e4e6792.js.map